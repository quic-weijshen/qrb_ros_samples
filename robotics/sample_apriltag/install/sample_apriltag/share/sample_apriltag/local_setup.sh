...
: ${AMENT_CURRENT_PREFIX:="/local/mnt/workspace/fulan/demo_templ/qrb_ros_samples_fulan/robotics/sample_apriltag/install/sample_apriltag"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sample_apriltag/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/sample_apriltag/environment/path.sh"
